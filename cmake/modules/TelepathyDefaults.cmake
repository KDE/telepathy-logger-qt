...
set(LIB_DESTINATION         "${CMAKE_INSTALL_FULL_LIBDIR}" CACHE INTERNAL "The subdirectory where libraries will be installed (default is ${CMAKE_INSTALL_FULL_LIBDIR})")
set(INCLUDE_DESTINATION     "${CMAKE_INSTALL_FULL_INCLUDEDIR}" CACHE INTERNAL "The subdirectory where header files will be installed (default is ${CMAKE_INSTALL_FULL_INCLUDEDIR})")
set(DATA_DESTINATION        "${CMAKE_INSTALL_FULL_DATADIR}/telepathy" CACHE INTERNAL "The subdirectory where data files will be installed (default is ${CMAKE_INSTALL_FULL_DATADIR}/telepathy)")
