 ...
 */
#ifndef _TelepathyLoggerQt4_global_h_HEADER_GUARD_
#define _TelepathyLoggerQt4_global_h_HEADER_GUARD_
...
# define TELEPATHY_LOGGER_QT4_EXPORT Q_DECL_EXPORT
#else
# define TELEPATHY_LOGGER_QT4_EXPORT Q_DECL_IMPORT
#endif

#if !defined(Q_OS_WIN) && !defined(Q_CC_NOKIAX86) && \
    !defined(Q_CC_RVCT) && defined(QT_VISIBILITY_AVAILABLE)
# define TELEPATHY_LOGGER_QT4_NO_EXPORT __attribute__((visibility("hidden")))
#else
# define TELEPATHY_LOGGER_QT4_NO_EXPORT
#endif
...
#define QTELEPATHYLOGGERQT4_WRAPPER_IMPL_BASECLASS(Class) \
  protected: \
...
#define QTELEPATHYLOGGERQT4_WRAPPER_IMPL_SUBCLASSED(Class, Superclass) \
  friend class ::TPLoggerQtWrapper; \
  private: \
    Class(struct _Tpl##Class *tplPtr, bool ref): \
...
#define QTELEPATHYLOGGERQT4_WRAPPER_GET_IMPL(_1, _2, NAME, ...) NAME

#define QTELEPATHYLOGGERQT4_WRAPPER(...) \
    QTELEPATHYLOGGERQT4_WRAPPER_GET_IMPL( \
        __VA_ARGS__, \
        QTELEPATHYLOGGERQT4_WRAPPER_IMPL_SUBCLASSED, \
        QTELEPATHYLOGGERQT4_WRAPPER_IMPL_BASECLASS)(__VA_ARGS__)
