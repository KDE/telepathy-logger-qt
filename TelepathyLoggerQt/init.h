 ...
 */
#ifndef _TelepathyLoggerQt_init_h_HEADER_GUARD_
#define _TelepathyLoggerQt_init_h_HEADER_GUARD_
...
/*!
 * \headerfile init.h <TelepathyLoggerQt/Init>
 * \brief Initialization of the telepathy logger qt4 bindings
 */

TELEPATHY_LOGGER_QT_EXPORT void init();
