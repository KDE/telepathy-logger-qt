...
TEMPLATE = lib
TARGET = telepathy-qt4-logger
VERSION = 0.1.0

DEPENDPATH += .. 
INCLUDEPATH += ..
CONFIG += qdbus staticlib
...
pkgconfig.files = TelepathyQt4Logger.pc

headers.path = $$INSTALL_ROOT/usr/include/telepathy-1.0/TelepathyQt4Logger
